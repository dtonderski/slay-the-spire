...
Status: captured-target coverage expanded for `trace-2026-06-18T16-50-50-232Z.jsonl`, `trace-2026-06-18T16-45-23-530Z.jsonl`, and `trace-2026-06-18T06-04-49-264Z.jsonl`. Seed-start mode now executes CODEX04's first map choice `CHOOSE 1`, verifies entry to floor 1, and checks the first encounter as a source-backed 54/54 HP Cultist with visible `DEBUG` intent. The corpus tests also pin CODEX04's first three observed map-choice and encounter targets plus full captured map topology/edges/room symbols for both CODEX04 and VERIFY01: floor 1 Cultist 54/54, floor 2 Spike Slime (S) 11/11 plus Acid Slime (M) 32/32, and floor 3 Louse 13/13 plus Louse 15/15. CODEX03 adds Lament-specific first-three encounter/max-HP coverage: Jaw Worm 1/43, Cultist 1/54, and two louses 1/12 plus 1/16. The core simulator now includes source-backed `StsRng` behavior for the STS `Random` wrapper / libGDX `RandomXS128`, decoded inclusive HP ranges for the reached Act 1 monsters including Jaw Worm, floor-offset `monsterHpRng = seed + floorNum` parity for VERIFY01/CODEX04 floor-1 Cultists plus CODEX04 floor-2 Small Slimes, CODEX04/CODEX03 floor-3 louses, and CODEX03 floor-1 Jaw Worm, decoded Exordium normal encounter list generation for weak and strong encounters, full VERIFY01/CODEX04 map parity, fixed target rows 0/8/14, bytecode-backed two-stage room-list construction, raw `Collections.shuffle` room-list prefix for VERIFY01/CODEX04, a target Exordium `FixedMap` projection that traverses the captured prefix through the normal map API, and minimized labeled divergence diagnostics for captured map, encounter, and HP sequence mismatches. Elite encounter selection, alternate unreached encounter branches, and full first-three-floor seed-start parity remain incomplete; CODEX04 seed-start still stops at the first unsupported combat command.
