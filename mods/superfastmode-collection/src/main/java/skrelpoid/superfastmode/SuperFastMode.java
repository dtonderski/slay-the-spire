...
public class SuperFastMode {
	...
	// Collection fork: fades/death animations use multiplied delta so
	// CommunicationMod is not blocked on real-time room transitions.

	public static void initialize() {
		logger.info("Initializing SuperFastMode (collection fork)");
