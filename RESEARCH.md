...
- Extend map parity from full CODEX04 topology/edge/room-symbol parity, fixed rows, desired room counts, shuffled room-list order, and `FixedMap` traversal into additional captured seeds and later reachable node choices.
