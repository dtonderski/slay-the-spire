...
- Extend map parity from source-backed topology path choices, fixed rows, desired room counts, shuffled room-list order, CODEX04 captured placement prefix, and `FixedMap` traversal into broader placement evidence and later reachable node choices.
