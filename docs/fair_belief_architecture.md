...
extends [`research_tree.md`](literature_review/research_tree.md),
[`combat_tree_search.md`](literature_review/combat_tree_search.md),
...
(matching the fidelity discipline in [`design.md`](design.md)). Scope is the currently
...
- Kill criterion: none — this is prerequisite infrastructure. But if
  ...
  core state, stop and write a design note in `docs/` first.
