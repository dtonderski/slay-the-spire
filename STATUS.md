...
Continue Milestone 22: extend CODEX04 map parity from full topology/edge evidence and captured-path room placement into full room-symbol placement, then first-three-floor seed-start parity once combat/reward replay dependencies are ready.
