...
Current milestone: Milestone 32B, deterministic content completion sweep. The latest local slice implements base Bloodletting (`BLOODLETTING`, ContentId(130)) as a deterministic 0-cost uncommon skill with focused definition, no-target legality, 3 HP loss, 2 energy gain, played discard movement, event-log order, Tungsten Rod mitigation, and Buffer prevention coverage. The M32A card matrix now marks Bloodletting `implemented` with explicit caveats that no played-card CommunicationMod trace parity or decoded source-backed action-order evidence is claimed yet. Prior local-test-only slices implemented base Ghostly Armor (`GHOSTLY_ARMOR`, ContentId(134)), base Pummel (`PUMMEL`, ContentId(118)), base Reckless Charge (`RECKLESS_CHARGE`, ContentId(113)), base Power Through (`POWER_THROUGH`, ContentId(111)), base Perfected Strike (`PERFECTED_STRIKE`, ContentId(109)), base Impervious (`IMPERVIOUS`, ContentId(146)), base Bludgeon (`BLUDGEON`, ContentId(139)), base Wild Strike (`WILD_STRIKE`, ContentId(107)), base Heavy Blade (`HEAVY_BLADE`, ContentId(108)), base Clash (`CLASH`, ContentId(102)), base Body Slam (`BODY_SLAM`, ContentId(101)), base Intimidate (`INTIMIDATE`, ContentId(115)), base Clothesline (`CLOTHESLINE`, ContentId(104)), and base Iron Wave (`IRON_WAVE`, ContentId(100)).
