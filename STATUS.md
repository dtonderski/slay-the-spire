...
Continue Milestone 29 by fixing the cleaned `M290001` fixture's card reward RNG/deck drift, then driving verification past the current step-173 Gremlin-fight boundary and onward to the Sentries fight. The cleaned single-run prefix can be structurally checked with:
