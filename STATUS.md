...
Current milestone: Milestone 32B, deterministic content completion sweep. The latest local slice implements base Shockwave (`SHOCKWAVE`, ContentId(120)) as a deterministic uncommon Ironclad skill: 2 energy, no target, exhaust, and applies 3 Weak, 3 Vulnerable, and -3 Strength to each living enemy while skipping dead enemies. Coverage includes definition/rarity/cost/target/exhaust, legality no-target and target/energy rejection, transition debuffs across living enemies only, exhaust movement, event-log order, Champion Belt's Vulnerable hook, and outgoing monster attack damage reduction from Strength down. The M32A card matrix now marks Shockwave `implemented` with caveats that upgraded Shockwave is not implemented, no clean played-card trace parity is claimed yet, the new 2026-06-25 full-run trace containing Shockwave is contaminated rather than a pristine oracle, and exact action order is local-test-covered only rather than source-backed. Prior local-test-only slices implemented base Dropkick (`DROPKICK`, ContentId(132)), base Disarm (`DISARM`, ContentId(124)), base Entrench (`ENTRENCH`, ContentId(126)), base Demon Form (`Demon Form`, ContentId(138)), base Regret (`Regret`, ContentId(62)), base Wound (`Wound`, ContentId(4)), base Dazed (`Dazed`, ContentId(5)), base Doubt (`Doubt`, ContentId(63)), base Sentinel (`SENTINEL`, ContentId(127)), base Hemokinesis (`HEMOKINESIS`, ContentId(114)), base Carnage (`CARNAGE`, ContentId(131)), base Bloodletting (`BLOODLETTING`, ContentId(130)), base Ghostly Armor (`GHOSTLY_ARMOR`, ContentId(134)), base Pummel (`PUMMEL`, ContentId(118)), base Reckless Charge (`RECKLESS_CHARGE`, ContentId(113)), base Power Through (`POWER_THROUGH`, ContentId(111)), base Perfected Strike (`PERFECTED_STRIKE`, ContentId(109)), base Impervious (`IMPERVIOUS`, ContentId(146)), base Bludgeon (`BLUDGEON`, ContentId(139)), base Wild Strike (`WILD_STRIKE`, ContentId(107)), base Heavy Blade (`HEAVY_BLADE`, ContentId(108)), base Clash (`CLASH`, ContentId(102)), base Body Slam (`BODY_SLAM`, ContentId(101)), base Intimidate (`INTIMIDATE`, ContentId(115)), base Clothesline (`CLOTHESLINE`, ContentId(104)), and base Iron Wave (`IRON_WAVE`, ContentId(100)).
