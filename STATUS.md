...
Current milestone: Milestone 32B, deterministic content completion sweep. The latest local slice implements base Sentinel (`SENTINEL`, ContentId(127)) as a deterministic 1-cost uncommon skill with focused definition, target legality, 5 block, Dexterity/Frail interaction, normal discard movement, no normal-play exhaust energy, and +2 energy when exhausted through existing card-aware exhaust hooks. The M32A card matrix now marks Sentinel `implemented` with explicit caveats that no played-card CommunicationMod trace parity, source-backed exhaust-order evidence, or upgraded Sentinel behavior is claimed yet. Prior local-test-only slices implemented base Hemokinesis (`HEMOKINESIS`, ContentId(114)), base Carnage (`CARNAGE`, ContentId(131)), base Bloodletting (`BLOODLETTING`, ContentId(130)), base Ghostly Armor (`GHOSTLY_ARMOR`, ContentId(134)), base Pummel (`PUMMEL`, ContentId(118)), base Reckless Charge (`RECKLESS_CHARGE`, ContentId(113)), base Power Through (`POWER_THROUGH`, ContentId(111)), base Perfected Strike (`PERFECTED_STRIKE`, ContentId(109)), base Impervious (`IMPERVIOUS`, ContentId(146)), base Bludgeon (`BLUDGEON`, ContentId(139)), base Wild Strike (`WILD_STRIKE`, ContentId(107)), base Heavy Blade (`HEAVY_BLADE`, ContentId(108)), base Clash (`CLASH`, ContentId(102)), base Body Slam (`BODY_SLAM`, ContentId(101)), base Intimidate (`INTIMIDATE`, ContentId(115)), base Clothesline (`CLOTHESLINE`, ContentId(104)), and base Iron Wave (`IRON_WAVE`, ContentId(100)).
