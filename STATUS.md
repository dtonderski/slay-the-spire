...
Continue Milestone 29 by driving the harvested `M290001` Sentries run past the current floor-2 combat boundary, then onward to the Sentries fight. The cleaned single-run prefix can be structurally checked with:
