...
Continue Milestone 29 by fixing the cleaned `M290001` fixture's remaining card-reward offer drift and M290001 map-entry comparison scope. The cleaned single-run prefix can be structurally checked with:
