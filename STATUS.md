...
Continue Milestone 29 by driving the cleaned `M290001` Sentries fixture past the current step-143 map/event boundary and onward to the Sentries fight. The cleaned single-run prefix can be structurally checked with:
