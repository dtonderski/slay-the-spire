...
Current milestone: Milestone 32B, deterministic content completion sweep. The latest local slice implements base Reckless Charge (`RECKLESS_CHARGE`, ContentId(113)) as a deterministic 0-cost uncommon attack with focused definition, target legality, 7 damage, attack modifier coverage, one generated Dazed to the draw pile with deterministic local ID/order, Havoc top-draw effect coverage, discard movement, and event-log coverage. The M32A card matrix now marks Reckless Charge `implemented` with explicit caveats that generated Dazed uses local draw-pile insertion semantics and that no played-card real-game trace parity is claimed yet. Prior local-test-only slices implemented base Power Through (`POWER_THROUGH`, ContentId(111)), base Perfected Strike (`PERFECTED_STRIKE`, ContentId(109)), base Impervious (`IMPERVIOUS`, ContentId(146)), base Bludgeon (`BLUDGEON`, ContentId(139)), base Wild Strike (`WILD_STRIKE`, ContentId(107)), base Heavy Blade (`HEAVY_BLADE`, ContentId(108)), base Clash (`CLASH`, ContentId(102)), base Body Slam (`BODY_SLAM`, ContentId(101)), base Intimidate (`INTIMIDATE`, ContentId(115)), base Clothesline (`CLOTHESLINE`, ContentId(104)), and base Iron Wave (`IRON_WAVE`, ContentId(100)).
