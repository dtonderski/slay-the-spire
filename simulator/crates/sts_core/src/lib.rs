...
pub use map::{
    ...
    generate_exordium_map_topology, exordium_room_kinds_on_path, generate_map_placeholder, generated_map_fixture,
...
pub use relic::{
    ...
    reset_turn_relic_counters, Relic, RelicCounters, ANCHOR_BLOCK, ANCHOR_ID,
