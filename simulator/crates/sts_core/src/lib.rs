...
pub mod adapter_internals {
    ...
    pub use crate::run::{
        ...
        apply_run_decision_action, apply_run_decision_action_after_validation, apply_shop_action,
        cancel_grid, confirm_grid, consume_neow_three_potions_hidden_card_reward,
        ...
        event_screen, generate_neow_card_reward, generate_neow_card_reward_with_rng,
        ...
        legal_shop_actions, match_and_keep_group_index_for_label,
        ...
        validate_run_decision_action, validate_run_decision_action_after_validation,
        validate_shop_action, Act1Boss, Act3Boss, CardGridScreen, CardRewardFlow, CombatRewardKind,
        Event, EventChoice, EventScreen, GeneratedNeowOption, GridPurpose, NeowBossSwapReward,
        NeowCardReward, NeowColorlessReward, NeowDrawback, NeowPotionReward, NeowRelicReward,
        NeowRewardType, NeowTransformReward, RewardContinuation, RewardScreen, RunAction,
        RunDecisionAction, RunPhase, RunState, ShopCardSlot, ShopPick, ShopPotionSlot,
