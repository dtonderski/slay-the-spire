...
pub mod adapter_internals {
    ...
    pub use crate::run::{
        ...
        target_relic_tier, tick_match_and_keep_wait, validate_event_action, validate_potion_action,
        validate_rest_action, validate_run_decision_action, validate_shop_action, Act1Boss,
        Act3Boss, CardGridScreen, CardRewardFlow, CombatRewardKind, Event, EventChoice,
        EventScreen, GeneratedNeowOption, GridPurpose, MapOverlay, NeowBossSwapReward,
