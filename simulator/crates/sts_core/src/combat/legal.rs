...
mod tests {
    ...
    use crate::{
        content::cards::{
            ...
            DISARM_ID, DUAL_WIELD_ID, ENTRENCH_ID, FEEL_NO_PAIN_ID, FLEX_ID, FLEX_PLUS_ID,
            GHOSTLY_ARMOR_ID, HAVOC_ID, HEAVY_BLADE_ID, HEMOKINESIS_ID, IMPERVIOUS_ID, INFLAME_ID,
            INFLAME_PLUS_ID, INTIMIDATE_ID, IRON_WAVE_ID, PERFECTED_STRIKE_ID, POMMEL_STRIKE_ID,
