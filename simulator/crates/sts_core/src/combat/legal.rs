...
mod tests {
    ...
    use crate::{
        content::cards::{
            ...
            CARNAGE_ID, CHRYSALIS_ID, CLASH_ID, CLEAVE_ID, CLEAVE_PLUS_ID, CLOTHESLINE_ID,
            COMBUST_ID, CORRUPTION_ID, DARK_EMBRACE_ID, DARK_SHACKLES_ID, DEEP_BREATH_ID,
            DEFEND_R_ID, DEMON_FORM_ID, DISARM_ID, DROPKICK_ID, DUAL_WIELD_ID, ENLIGHTENMENT_ID,
            ENTRENCH_ID, EVOLVE_ID, FEED_ID, FEEL_NO_PAIN_ID, FIEND_FIRE_ID, FINESSE_ID,
            FIRE_BREATHING_ID, FLAME_BARRIER_ID, FLASH_OF_STEEL_ID, FLEX_ID, FLEX_PLUS_ID,
            FORETHOUGHT_ID, GHOSTLY_ARMOR_ID, GOOD_INSTINCTS_ID, HAVOC_ID, HEADBUTT_ID,
            ...
            LIMIT_BREAK_ID, MAGNETISM_ID, MASTER_OF_STRATEGY_ID, METAMORPHOSIS_ID, MIND_BLAST_ID,
            OFFERING_ID, PANACEA_ID, PANIC_BUTTON_ID, PERFECTED_STRIKE_ID, POMMEL_STRIKE_ID,
    ...
    #[test]
    fn reaper_is_legal_without_target_when_enemy_is_alive() {
        let state = hand_with_card(REAPER_ID);
    ...
    #[test]
    fn evolve_is_legal_without_target() {
        let state = hand_with_card(EVOLVE_ID);
        assert!(
            legal_combat_actions(&state).contains(&CombatAction::PlayCard {
                card_id: CardId::new(20),
                target: None,
    ...
    #[test]
    fn feed_is_legal_with_target_at_one_energy() {
        let mut state = hand_with_card(FEED_ID);
    ...
    #[test]
    fn good_instincts_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(GOOD_INSTINCTS_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn bandage_up_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(BANDAGE_UP_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn bandage_up_rejects_target() {
        let state = hand_with_card(BANDAGE_UP_ID);
    ...
    #[test]
    fn violence_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(VIOLENCE_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn violence_rejects_target() {
        let state = hand_with_card(VIOLENCE_ID);
    ...
    #[test]
    fn finesse_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(FINESSE_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn master_of_strategy_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(MASTER_OF_STRATEGY_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn master_of_strategy_rejects_target() {
        let state = hand_with_card(MASTER_OF_STRATEGY_ID);
    ...
    #[test]
    fn flash_of_steel_is_legal_with_target_at_zero_energy() {
        let mut state = hand_with_card(FLASH_OF_STEEL_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn flash_of_steel_rejects_missing_target() {
        let state = hand_with_card(FLASH_OF_STEEL_ID);
    ...
    #[test]
    fn panacea_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(PANACEA_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn panacea_rejects_target() {
        let state = hand_with_card(PANACEA_ID);
    ...
    #[test]
    fn entrench_is_legal_without_target_at_two_energy() {
        let state = hand_with_card(ENTRENCH_ID);
    ...
    #[test]
    fn entrench_is_illegal_below_two_energy() {
        let mut state = hand_with_card(ENTRENCH_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn entrench_uses_temp_cost_for_legality() {
        let mut state = hand_with_card(ENTRENCH_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn fiend_fire_is_legal_with_target() {
    ...
    #[test]
    fn fiend_fire_is_illegal_at_one_energy() {
        let mut state = hand_with_card(FIEND_FIRE_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn shockwave_is_illegal_at_one_energy() {
        let mut state = hand_with_card(SHOCKWAVE_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn disarm_is_legal_with_living_target() {
        let state = hand_with_card(DISARM_ID);
    ...
    #[test]
    fn dark_shackles_rejects_missing_target() {
        let state = hand_with_card(DARK_SHACKLES_ID);
    ...
    #[test]
    fn dark_shackles_rejects_dead_target() {
        let mut state = hand_with_card(DARK_SHACKLES_ID);
        state.monsters[0].alive = false;
    ...
    #[test]
    fn disarm_rejects_missing_target() {
        let state = hand_with_card(DISARM_ID);
    ...
    #[test]
    fn disarm_rejects_dead_target() {
        let mut state = hand_with_card(DISARM_ID);
        state.monsters[0].alive = false;
    ...
    #[test]
    fn disarm_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(DISARM_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn dropkick_is_legal_with_living_target() {
        let state = hand_with_card(DROPKICK_ID);
    ...
    #[test]
    fn dropkick_rejects_missing_target() {
        let state = hand_with_card(DROPKICK_ID);
    ...
    #[test]
    fn dropkick_rejects_dead_target() {
        let mut state = hand_with_card(DROPKICK_ID);
        state.monsters[0].alive = false;
    ...
    #[test]
    fn dropkick_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(DROPKICK_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn second_wind_is_legal_without_target() {
        let state = hand_with_card(SECOND_WIND_ID);
    ...
    #[test]
    fn second_wind_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(SECOND_WIND_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn corruption_is_legal_without_target_at_three_energy() {
        let mut state = hand_with_card(CORRUPTION_ID);
        state.player.energy = 3;
    ...
    #[test]
    fn corruption_is_illegal_below_three_energy_before_power_is_active() {
        let mut state = hand_with_card(CORRUPTION_ID);
        state.player.energy = 2;
    ...
    #[test]
    fn corruption_makes_skills_legal_at_zero_energy() {
        let mut state = hand_with_card(DEFEND_R_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn berserk_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(BERSERK_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn combust_is_legal_without_target_at_one_energy() {
        let mut state = hand_with_card(COMBUST_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn brutality_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(BRUTALITY_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn infernal_blade_is_legal_without_target_at_one_energy() {
        let mut state = hand_with_card(INFERNAL_BLADE_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn infernal_blade_rejects_target() {
        let mut state = hand_with_card(INFERNAL_BLADE_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn infernal_blade_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(INFERNAL_BLADE_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn chrysalis_is_legal_without_target_at_two_energy() {
        let mut state = hand_with_card(CHRYSALIS_ID);
        state.player.energy = 2;
    ...
    #[test]
    fn chrysalis_is_illegal_below_two_energy() {
        let mut state = hand_with_card(CHRYSALIS_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn sadistic_nature_is_legal_without_target_at_zero_energy() {
    ...
    #[test]
    fn magnetism_is_legal_without_target_at_two_energy() {
        let mut state = hand_with_card(MAGNETISM_ID);
        state.player.energy = 2;
    ...
    #[test]
    fn magnetism_is_illegal_below_two_energy() {
        let mut state = hand_with_card(MAGNETISM_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn jack_of_all_trades_is_legal_without_target_at_zero_energy() {
        let mut state = hand_with_card(JACK_OF_ALL_TRADES_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn jack_of_all_trades_rejects_target() {
        let mut state = hand_with_card(JACK_OF_ALL_TRADES_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn rupture_is_legal_without_target_at_one_energy() {
        let mut state = hand_with_card(RUPTURE_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn fire_breathing_is_legal_without_target_at_one_energy() {
        let mut state = hand_with_card(FIRE_BREATHING_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn fire_breathing_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(FIRE_BREATHING_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn rampage_is_legal_with_target_at_one_energy() {
        let mut state = hand_with_card(RAMPAGE_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn rampage_rejects_missing_target() {
        let mut state = hand_with_card(RAMPAGE_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn rampage_is_illegal_below_one_energy() {
        let mut state = hand_with_card(RAMPAGE_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn limit_break_is_legal_without_target_at_one_energy() {
        let mut state = hand_with_card(LIMIT_BREAK_ID);
        state.player.energy = 1;
    ...
    #[test]
    fn limit_break_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(LIMIT_BREAK_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn armaments_is_legal_without_target() {
        let state = hand_with_card(ARMAMENTS_ID);
    ...
    #[test]
    fn armaments_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(ARMAMENTS_ID);
        state.player.energy = 0;
    ...
    #[test]
    fn headbutt_is_legal_with_target() {
        let state = hand_with_card(HEADBUTT_ID);
    ...
    #[test]
    fn headbutt_rejects_missing_target() {
        let state = hand_with_card(HEADBUTT_ID);
    ...
    #[test]
    fn headbutt_rejects_dead_target() {
        let mut state = hand_with_card(HEADBUTT_ID);
        state.monsters[0].alive = false;
    ...
    #[test]
    fn headbutt_is_illegal_at_zero_energy() {
        let mut state = hand_with_card(HEADBUTT_ID);
        state.player.energy = 0;
