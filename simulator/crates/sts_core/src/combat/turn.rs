use crate::{
    ...
    content::monsters::{
        ...
        target_snecko_next_intent_from_roll, ACID_SLIME_ID, ACID_SLIME_M_A7_HP_RANGE,
        ACID_SLIME_S_A7_HP_RANGE, BRONZE_AUTOMATON_ID,
        ...
        SHELLED_PARASITE_ID, SNAKE_PLANT_ID, SNECKO_ID, SPHERIC_GUARDIAN_ID,
    },
    ids::MonsterId,
    rng::JavaRng,
    TargetRequirement,
