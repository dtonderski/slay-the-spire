use crate::{
    ...
    content::cards::{
        ...
        BURNING_PACT_ID, BURNING_PACT_PLUS_ID, CHARGE_BATTERY_ANY_COLOR_ID, CHRYSALIS_ID,
        CHRYSALIS_PLUS_ID, CLASH_ID, CLASH_PLUS_ID, CLEAVE_ID, CLEAVE_PLUS_ID,
        CLOAK_AND_DAGGER_ANY_COLOR_ID, CLOTHESLINE_ID, CLOTHESLINE_PLUS_ID, COMBUST_ID,
        ...
        DISARM_PLUS_ID, DISCOVERY_ID, DISCOVERY_PLUS_ID, DOPPELGANGER_ANY_COLOR_ID, DOUBLE_TAP_ID,
        ...
        EQUILIBRIUM_ANY_COLOR_ID, EVOLVE_ID, EVOLVE_PLUS_ID, EXHUME_ID, EXHUME_PLUS_ID, FEED_ID,
        ...
        HEAVY_BLADE_ID, HEAVY_BLADE_PLUS_ID, HEMOKINESIS_ID, HEMOKINESIS_PLUS_ID, IMMOLATE_ID,
