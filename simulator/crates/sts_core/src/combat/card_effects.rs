use crate::{
    ...
    content::cards::{
        ...
        EQUILIBRIUM_ANY_COLOR_ID, EVOLVE_ID, EVOLVE_PLUS_ID, EXHUME_ID, EXHUME_PLUS_ID,
        FASTING_ANY_COLOR_ID, FEED_ID, FEED_PLUS_ID, FEEL_NO_PAIN_ID, FEEL_NO_PAIN_PLUS_ID,
