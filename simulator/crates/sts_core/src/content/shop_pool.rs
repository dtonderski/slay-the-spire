...
use crate::content::cards::{
    ...
    MASTER_OF_STRATEGY_ID, MAYHEM_ID, METALLICIZE_ID, METAMORPHOSIS_ID, MIND_BLAST_ID, OFFERING_ID,
    ...
    SECRET_WEAPON_ID, SEEING_RED_ID, SENTINEL_ID, SEVER_SOUL_ID, SHOCKWAVE_ID, SHRUG_IT_OFF_ID,
    SPOT_WEAKNESS_ID, SWIFT_STRIKE_ID, SWORD_BOOMERANG_ID, THE_BOMB_ID, THINKING_AHEAD_ID,
    THUNDERCLAP_ID, TRANSMUTATION_ID, TRIP_ID, TRUE_GRIT_ID, TWIN_STRIKE_ID, UPPERCUT_ID,
    VIOLENCE_ID, WARCRY_ID, WHIRLWIND_ID, WILD_STRIKE_ID,
};
...
mod tests {
    ...
    use crate::content::cards::{
        ...
        JACK_OF_ALL_TRADES_ID, MASTER_OF_STRATEGY_ID, METAMORPHOSIS_ID, MIND_BLAST_ID, PANACEA_ID,
        PANIC_BUTTON_ID, SADISTIC_NATURE_ID, SECRET_TECHNIQUE_ID, SWIFT_STRIKE_ID, THE_BOMB_ID,
        THINKING_AHEAD_ID, TRANSMUTATION_ID, TRIP_ID, VIOLENCE_ID,
    };
