...
use crate::content::cards::{
    ...
    DEMON_FORM_ID, DISARM_ID, DOUBLE_TAP_ID, DROPKICK_ID, DUAL_WIELD_ID, ENTRENCH_ID, EVOLVE_ID,
    EXHUME_ID, FEEL_NO_PAIN_ID, FEED_ID, FIEND_FIRE_ID, FIRE_BREATHING_ID, FLEX_ID, FLAME_BARRIER_ID, GHOSTLY_ARMOR_ID,
    HAVOC_ID, HEADBUTT_ID, HEAVY_BLADE_ID, HEMOKINESIS_ID, IMMOLATE_ID, IMPERVIOUS_ID,
    INFERNAL_BLADE_ID, INFLAME_ID, INTIMIDATE_ID, IRON_WAVE_ID, JUGGERNAUT_ID, LIMIT_BREAK_ID,
    METALLICIZE_ID, OFFERING_ID, PERFECTED_STRIKE_ID, POMMEL_STRIKE_ID, POWER_THROUGH_ID,
    ...
    UPPERCUT_ID, WARCRY_ID, WHIRLWIND_ID, WILD_STRIKE_ID, DRAMATIC_ENTRANCE_ID,
};
use crate::rng::StsRng;
use crate::ContentId;

const IRONCLAD_ATTACK_COMMON: &[&str] = &[
    "ANGER", "BODY_SLAM", "CLASH", "CLEAVE", "CLOTHESLINE", "HEADBUTT", "HEAVY_BLADE", "IRON_WAVE",
    "PERFECTED_STRIKE", "POMMEL_STRIKE", "SWORD_BOOMERANG", "THUNDERCLAP", "TWIN_STRIKE",
    "WILD_STRIKE",
];
const IRONCLAD_ATTACK_UNCOMMON: &[&str] = &[
    "BLOOD_FOR_BLOOD", "CARNAGE", "DROPKICK", "HEMOKINESIS", "PUMMEL", "RAMPAGE",
    "RECKLESS_CHARGE", "SEARING_BLOW", "SEVER_SOUL", "UPPERCUT", "WHIRLWIND",
];
...
const IRONCLAD_SKILL_UNCOMMON: &[&str] = &[
    "BATTLE_TRANCE", "BLOODLETTING", "BURNING_PACT", "DISARM", "DUAL_WIELD", "ENTRENCH",
    "FLAME_BARRIER", "GHOSTLY_ARMOR", "INFERNAL_BLADE", "INTIMIDATE", "POWER_THROUGH", "RAGE",
    "SECOND_WIND", "SEEING_RED", "SENTINEL", "SHOCKWAVE", "SPOT_WEAKNESS",
];
const IRONCLAD_SKILL_RARE: &[&str] = &[
    "DOUBLE_TAP", "EXHUME", "IMPERVIOUS", "LIMIT_BREAK", "OFFERING",
];
const IRONCLAD_POWER_UNCOMMON: &[&str] = &[
    "COMBUST", "DARK_EMBRACE", "EVOLVE", "FEEL_NO_PAIN", "FIRE_BREATHING", "INFLAME",
    "METALLICIZE", "RUPTURE",
];
...
const COLORLESS_UNCOMMON: &[&str] = &[
    "BANDAGE_UP", "BLIND", "DARK_SHACKLES", "DEEP_BREATH", "DISCOVERY", "DRAMATIC_ENTRANCE",
    "ENLIGHTENMENT", "FINESSE", "FLASH_OF_STEEL", "FORETHOUGHT", "GOOD_INSTINCTS", "IMPATIENCE",
    "JACK_OF_ALL_TRADES", "MADNESS", "MIND_BLAST", "PANACEA", "PANIC_BUTTON", "PURITY",
    "SWIFT_STRIKE", "TRIP",
];
const COLORLESS_RARE: &[&str] = &[
    "APOTHEOSIS", "CHRYSALIS", "HAND_OF_GREED", "MAGNETISM", "MASTER_OF_STRATEGY", "MAYHEM",
    "METAMORPHOSIS", "PANACHE", "SADISTIC_NATURE", "SECRET_TECHNIQUE", "SECRET_WEAPON",
    "THE_BOMB", "THINKING_AHEAD", "TRANSMUTATION", "VIOLENCE",
];
...
fn stable_pool_name_id(name: &str) -> u64 {
    name.bytes().fold(0u64, |acc, byte| acc.wrapping_mul(31).wrapping_add(u64::from(byte)))
}
