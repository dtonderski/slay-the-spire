...
use crate::content::cards::{
    ...
    BRUTALITY_ID, BURNING_PACT_ID, CARNAGE_ID, CLASH_ID, CLEAVE_ID, CLOTHESLINE_ID, COMBUST_ID,
    CORRUPTION_ID, DARK_EMBRACE_ID, DARK_SHACKLES_ID, DEEP_BREATH_ID, DEMON_FORM_ID, DISARM_ID,
    ...
    IMMOLATE_ID, IMPATIENCE_ID, IMPERVIOUS_ID, INFERNAL_BLADE_ID, INFLAME_ID, INTIMIDATE_ID,
