...
use crate::content::cards::{
    ...
    JUGGERNAUT_ID, LIMIT_BREAK_ID, MADNESS_ID, MASTER_OF_STRATEGY_ID, MAYHEM_ID, METALLICIZE_ID,
    METAMORPHOSIS_ID, MIND_BLAST_ID, OFFERING_ID, PANACEA_ID, PANACHE_ID, PERFECTED_STRIKE_ID,
