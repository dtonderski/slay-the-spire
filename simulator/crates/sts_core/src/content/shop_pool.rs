...
use crate::content::cards::{
    ...
    PURITY_ID, RAGE_ID, RAMPAGE_ID, REAPER_ID, RECKLESS_CHARGE_ID, RUPTURE_ID, SEARING_BLOW_ID,
    SECOND_WIND_ID, SECRET_TECHNIQUE_ID, SECRET_WEAPON_ID, SEEING_RED_ID, SENTINEL_ID,
...
mod tests {
    ...
    use crate::content::cards::{
        ...
        SECRET_TECHNIQUE_ID, SWIFT_STRIKE_ID, THE_BOMB_ID, THINKING_AHEAD_ID, TRANSMUTATION_ID,
        TRIP_ID, VIOLENCE_ID,
    };
