...
use crate::content::cards::{
    ...
    PANACEA_ID, PANACHE_ID, PERFECTED_STRIKE_ID, POMMEL_STRIKE_ID, POWER_THROUGH_ID, PUMMEL_ID,
    PURITY_ID, RAGE_ID, RAMPAGE_ID, REAPER_ID, RECKLESS_CHARGE_ID, RUPTURE_ID, SADISTIC_NATURE_ID,
    ...
    SWORD_BOOMERANG_ID, THE_BOMB_ID, THINKING_AHEAD_ID, THUNDERCLAP_ID, TRANSMUTATION_ID, TRIP_ID,
    TRUE_GRIT_ID, TWIN_STRIKE_ID, UPPERCUT_ID, VIOLENCE_ID, WARCRY_ID, WHIRLWIND_ID,
    WILD_STRIKE_ID,
};
...
mod tests {
    ...
    use crate::content::cards::{
        ...
        SADISTIC_NATURE_ID, SECRET_TECHNIQUE_ID, SWIFT_STRIKE_ID, THE_BOMB_ID, THINKING_AHEAD_ID,
        TRANSMUTATION_ID, TRIP_ID, VIOLENCE_ID,
    };
