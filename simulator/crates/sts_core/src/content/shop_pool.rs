...
use crate::content::cards::{
    ...
    DARK_SHACKLES_ID, DEMON_FORM_ID, DISARM_ID, DOUBLE_TAP_ID, DRAMATIC_ENTRANCE_ID, DROPKICK_ID,
    DUAL_WIELD_ID, ENTRENCH_ID, EVOLVE_ID, EXHUME_ID, FEED_ID, FEEL_NO_PAIN_ID, FIEND_FIRE_ID,
    FIRE_BREATHING_ID, FLAME_BARRIER_ID, FLASH_OF_STEEL_ID, FLEX_ID, GHOSTLY_ARMOR_ID,
    GOOD_INSTINCTS_ID, HAVOC_ID, HEADBUTT_ID, HEAVY_BLADE_ID, HEMOKINESIS_ID, IMMOLATE_ID,
    IMPERVIOUS_ID, INFERNAL_BLADE_ID, INFLAME_ID, INTIMIDATE_ID, IRON_WAVE_ID, JUGGERNAUT_ID,
    LIMIT_BREAK_ID, METALLICIZE_ID, OFFERING_ID, PANACEA_ID, PERFECTED_STRIKE_ID, POMMEL_STRIKE_ID,
...
mod tests {
    use super::*;
    use crate::content::cards::{
        BANDAGE_UP_ID, BLIND_ID, DARK_SHACKLES_ID, FLASH_OF_STEEL_ID, GOOD_INSTINCTS_ID,
