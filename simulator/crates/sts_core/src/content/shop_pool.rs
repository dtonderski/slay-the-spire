...
use crate::content::cards::{
    ...
    FLASH_OF_STEEL_ID, FLEX_ID, GHOSTLY_ARMOR_ID, GOOD_INSTINCTS_ID, HAVOC_ID, HEADBUTT_ID,
...
mod tests {
    ...
    use crate::content::cards::{
        ...
        FLASH_OF_STEEL_ID, GOOD_INSTINCTS_ID, IMPATIENCE_ID, PANACEA_ID, SWIFT_STRIKE_ID, TRIP_ID,
    };
