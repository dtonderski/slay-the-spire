...
upload() {
  ...
  HF_HUB_DISABLE_XET=1 \
    PYTHONPATH="$repo_root/simulator/tools/hf_ipv4${PYTHONPATH:+:$PYTHONPATH}" \
...
*)
  cat >&2 <<'EOF'
usage:
  simulator/tools/hf_corpus.sh upload [owner/dataset]
  simulator/tools/hf_corpus.sh download [owner/dataset]
