...
function usage() {
  console.error("Usage:");
  console.error("  node simulator/tools/communication/trace_tools.js validate <trace.jsonl>");
  console.error("  node simulator/tools/communication/trace_tools.js report <trace.jsonl>");
  console.error("  node simulator/tools/communication/trace_tools.js trim-valid-prefix <input.jsonl> <output.jsonl>");
  console.error("  node simulator/tools/communication/trace_tools.js extract-run <input.jsonl> <run-index> <output.jsonl>");
  console.error("  node simulator/tools/communication/trace_tools.js extract-best-run <input.jsonl> <output.jsonl>");
  console.error("  node simulator/tools/communication/trace_tools.js collapse-card-reward-loop <input.jsonl> <output.jsonl>");
  process.exit(2);
}
