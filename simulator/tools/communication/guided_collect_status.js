...
const defaultReportPath = path.join(repoRoot, "simulator", "python", "target", "guided-collect", "latest.json");
const defaultArchiveDir = path.join(repoRoot, "simulator", "python", "target", "guided-collect", "reports");
const defaultSessionDir = path.join(repoRoot, "simulator", "tools", "communication", "session");
