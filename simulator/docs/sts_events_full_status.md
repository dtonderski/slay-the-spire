...
| 50 | SensoryStone | Complete | Live Interact/Recall labels, HP costs, eager one-to-three colorless reward overlays, and final Leave; source bytecode plus session-22/23/25 seed-start regressions |
