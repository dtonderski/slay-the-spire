...
| 50 | SensoryStone | Complete | Live Interact/Recall labels, HP costs, eager one-to-three colorless reward overlays, reward skipping, and final Leave; source bytecode plus session-22/23/25/27 seed-start regressions |
