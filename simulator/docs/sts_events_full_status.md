...
| 52 | WindingHalls | Complete | Live `...` intro and `Embrace Madness`/`Focus`/`Retrace Your Steps` labels plus source-backed Madness/Writhe visual-obtain staging and Max-HP mapping; session-29 seed-start regressions |
