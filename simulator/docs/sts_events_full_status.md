...
| 52 | WindingHalls | Complete | Live `...` intro and `Embrace Madness`/`Focus`/`Retrace Your Steps` labels plus Madness/Writhe/Max-HP mappings; session-29 seed-start regressions |
