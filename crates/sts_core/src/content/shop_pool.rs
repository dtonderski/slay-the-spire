...
use crate::content::cards::{
    ...
    INFLAME_ID, INTIMIDATE_ID, IRON_WAVE_ID, JACK_OF_ALL_TRADES_ID, JUDGEMENT_ANY_COLOR_ID,
    JUGGERNAUT_ID, LIMIT_BREAK_ID, MADNESS_ID, MAGNETISM_ID, MASTER_OF_STRATEGY_ID, MAYHEM_ID,
    METALLICIZE_ID, METAMORPHOSIS_ID, MIND_BLAST_ID, OFFERING_ID, PANACEA_ID, PANACHE_ID,
    PANIC_BUTTON_ID, PERFECTED_STRIKE_ID, POMMEL_STRIKE_ID, POWER_THROUGH_ID, PUMMEL_ID, PURITY_ID,
    RAGE_ID, RAMPAGE_ID, REAPER_ID, RECKLESS_CHARGE_ID, RUPTURE_ID, SADISTIC_NATURE_ID,
...
pub fn shop_card_content_id(name: &str) -> ContentId {
    match name {
        ...
        "JUDGEMENT" => JUDGEMENT_ANY_COLOR_ID,
        "MADNESS" => MADNESS_ID,
